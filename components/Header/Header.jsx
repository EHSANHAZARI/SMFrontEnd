          ...
          <div className="navbar-nav ms-auto p-4 p-lg-0">
            ...
            {(() => {
              switch (auth.user?.role) {
                case 1:
                  return <Link to="/Admin/Jobs/Post-Job" className="nav-item nav-link">Post Job</Link>
                case 2:
                  return <Link to="/Employer/Jobs/Post-Job" className="nav-item nav-link">Post Job</Link>
                default:
                  return <Link to="/Login" className="nav-item nav-link">Post Job</Link>
              }
            })()}
            {/* {!auth.user ? (
                  ...
                  (
                    ...
                    <div className="nav-item dropdown" style={{marginRight: "20px"}}>
                        <Link
                            ...
                            data-bs-toggle=""
                        >
                          <img src={auth?.user?.photo} alt={auth?.user?.firstname} style={{ width: "70px", height: "70px", borderRadius: "50%"}} />
                        </Link>
                        <div className="dropdown-menu rounded-0 m-0" >
