                        ...
                        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                                <li class="nav-item">
                                    ...
                                    <Link class="nav-link active" to="/Admin/Dashboard" onClick={() => { window.location.href = "/Applicant/Dashboard" }}>
                                        <span class="nav-icon">
                                    ...
                                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                        <ul class="submenu-list list-unstyled">
                                            <li class="submenu-item">
                                                <Link class="submenu-link" to="/Admin/Jobs/Manage-Jobs" onClick={() => { window.location.href = "/Applicant/Jobs/Manage-Jobs" }}>
                                                    View Applied Jobs
                                                </Link>
                                            </li>
                                            <li class="submenu-item">
                                                <Link class="submenu-link" to="/Admin/Jobs/Post-Job" onClick={() => { window.location.href = "/Applicant/Skill/Add-Job" }}>
                                                    Add New Skill
                                                </Link>
                                            </li>
                                            {/* <li class="submenu-item">
