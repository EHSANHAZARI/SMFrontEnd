            ...
            <div className="row g-5 align-items-center">
              ...
              <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <p className="mb-4">
                  ...
                  struggle immensely in their pursuit of identifying and
                  retaining such top-tier talent.
                </p>
                ...
                <p>
                  <i className="fa fa-check text-primary me-3"></i>The most
                  recent updates regarding hiring ministries.
                </p>
                <p>
                ...
                <Link
                  className="btn btn-primary rounded-0 py-3 px-5 mt-3"
                  to="/"
                >
                  Read More
                </Link>
            ...
            <div className="row align-items-center">
              <div className="col-md-7">
                <div className="section_title pb-25">
                  ...
                  <strong>
                    <span>
                      Page {currentPage} of {totalJobs} Active Jobs Found
                    </span>
                  </strong>
                  )
                </div>
                          ...
                          <div className="single_jobs text-center mt-30">
                            ...
                            <div className="jobs_meta d-flex justify-content-between">
                              <p className="location">
                                ...
                                <small>{j?.province?.provinceName}</small>
                              </p>
                              <p className="time">
                            ...
                            <p className="text-mute">
                              ...
                              >
                                <i className="fa fa-clock"></i> Posted{" "}
                                {moment
                              ...
                              <small
                                style={{ fontSize: "12px", color: "#aaa" }}
                              >
                                <i className="fas fa-business-time"></i> Apply
                                Before:{" "}
                                <span>
                                  {moment(j.deadlineDate).format("ll")}
                                </span>
                              </small>
                            </p>
                            <div className="jobs_btn">
                              <Link
                                to="#/"
                                className="main-btn main-btn-2 me-3 rounded-0"
                              >
                                Apply Now
                              </Link>

                              <Link
                                to={`/Job-Details/${j.slug}`}
                                className="main-btn main-btn-2 rounded-0"
                              >
                                Read More
                              </Link>
                            </div>
                      ...
                      {pageNumbers.map((number) => (
                        ...
                        >
                          <Link
                            ...
                            disabled={currentPage === Math.ceil(totalJobs / 6)}
                            to="#"
                            className="page-link"
                          >
                            {number}
